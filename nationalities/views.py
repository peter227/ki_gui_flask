...
def index_view():
    ...
    return render_template('nationalities/index.html', nationalities=nationalities, title="SQLAlchemyORM - Nationalities", url='nationalities.index_view', name=nationalities)
